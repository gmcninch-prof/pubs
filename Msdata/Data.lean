...
def getAbstract (file : String) : IO String := 
  IO.FS.readFile <|
    String.intercalate "/"
      [ "my-paper-data"
      , file ]
...
def local_global : IO MS := do
  ...
  pure
    { authors  := [DavidHarbater, JuliaHartmann, GeorgeMcNinch]
    , citation := Citation.PrePrint (year := 2026)
    , id       := "hhm26"
    , abstract := some abs
    , urls     :=
        [ UrlType.Arxiv (arxivId := "2603.26501")
        ]
...
def nilpotent_orbits_over_local_field : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s10468-020-10000-2")
        , UrlType.Other
            (label := "AlgRepTheory")
...
def reductive_subgroup_schemes : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s00031-018-9508-3")
        , UrlType.Other
            (label := "TransfGroups")
            (url   := "https://rdcu.be/bb6vn")
        , UrlType.MR
            (mrNumber := "MR4070108")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch20:reductive-subgroup-schemes.bib")
        , UrlType.Errata
            (path := errataPath "2025-10-12--reductive-subgroups-fix.pdf")
        ]
...
def central_subalgebras : IO MS := do
  ...
  pure
    { authors  := [GeorgeMcNinch, DonnaTesterman]
    , citation := Citation.Journal
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1090/proc/12942")
        , UrlType.MR
            (mrNumber := "MR3477055")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch16:MR3477055.bib")
        ]
...
def linearity : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/j.jalgebra.2013.08.030")
        , UrlType.MR
            (mrNumber := "MR3119244")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch14:MR3181732.bib")
        ]
...
def levi_special_fiber_parahoric : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s10468-013-9404-4")
        , UrlType.MR
            (mrNumber := "MR3181732")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch14:MR3181732.bib")
...
def descent_levi_factors : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s00013-012-0467-y")
        , UrlType.MR
            (mrNumber := "MR3009659")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch13:MR3009659.bib")
        ]
...
def good_filtration_subgroups : IO MS := do
  ...
  pure
    { authors  := [ChuckHague, GeorgeMcNinch]
    , citation := Citation.Journal
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/j.jpaa.2013.04.005")
        , UrlType.Arxiv
            (arxivId := "1205.1719")
        , UrlType.MR
            (mrNumber := "MR3057320")
        , UrlType.Bibtex
            (path := bibtexPath "hague13:MR3057320.bib")
        ]
...
def levi_decompositions : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s00031-010-9111-8")
        , UrlType.Arxiv
            (arxivId := "1007.2777")
        , UrlType.MR
            (mrNumber := "MR2753264")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch10:MR2753264.bib")
        , UrlType.Errata
            (path := errataPath "errata-levi-decompositions.pdf")
        ]
...
def nilpotent_centralizers : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/j.jpaa.2008.12.007")
        , UrlType.Arxiv
            (arxivId := "0805.2574")
        , UrlType.MR
            (mrNumber := "MR2497582")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch09:MR2497582.bib")
        ]
...
def nilpotent_subalgebras : IO MS := do
  ...
  pure
    { authors  := [PaulLevy, GeorgeMcNinch, DonnaTesterman]
    , citation := Citation.Journal
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/j.crma.2009.03.015")
        , UrlType.MR
            (mrNumber := "mr2576893")
        , UrlType.Bibtex
            (path := bibtexPath "levy09:MR2576893.bib")
        ]
...
def centralizer_nilpotent_section : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "the-centralizer-of-a-nilpotent-section.pdf")
        , UrlType.Euclid
            (euclidId := "euclid.nmj/1214229081")
        , UrlType.Arxiv
            (arxivId := "math.RT/0605626")
        , UrlType.MR
            (mrNumber := "MR2423832")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch08:MR2423832.bib")
        , UrlType.Errata
            (path := errataPath "errata--the-centralizer-of-a-nilpotent-section.pdf")
        ]
...
def cr_lie_subalgebras : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "completely-reducible-lie-subalgebras-revised-dec.pdf")
        , UrlType.DOI
            (doiNumber := "10.1007/s00031-005-1130-5")
        , UrlType.Arxiv
            (arxivId := "math.RT/0509590")
        , UrlType.MR
            (mrNumber := "MR2308032")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch07:MR2308032.bib")
        ]
...
def cr_sl2_homs : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "completely-reducible-sl(2)-homomorphisms.pdf")
        , UrlType.DOI
            (doiNumber := "10.1090/S0002-9947-07-04289-4")
        , UrlType.Arxiv
            (arxivId := "math.RT/0510377")
        , UrlType.MR
            (mrNumber := "MR2309195")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch07:MR2309195.bib")
        ]
...
def centralizer_sum_commuting : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/j.jpaa.2005.04.016")
        , UrlType.Arxiv
            (arxivId := "math.RT/0412283")
        , UrlType.MR
            (mrNumber := "MR2220085")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch06:MR2220085.bib")
        ]
    , title    := "On the centralizer of the sum of commuting nilpotent elements"
    }
...
def optimal_sl2 : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "optimal-sl(2)-homomorphisms.pdf")
        , UrlType.DOI
            (doiNumber := "10.4171/CMH/19")
        , UrlType.Arxiv
            (arxivId := "math.RT/0309385")
        , UrlType.MR
            (mrNumber := "MR2142248")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch05:MR2142248.bib")
        ]
...
def nilpotent_over_ground_field : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s00208-004-0510-9")
        , UrlType.Arxiv
            (arxivId := "math.RT/0209151")
        , UrlType.MR
            (mrNumber := "MR2052869")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch04:MR2052869.bib")
        ]
...
def sub_principal : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s00209-003-0508-0")
        , UrlType.Arxiv
            (arxivId := "math/0108140")
        , UrlType.MR
            (mrNumber := "MR1992546")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch03:MR1992546.bib")
        ]
...
def sl2_Witt : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/S0021-8693(03)00269-2")
        , UrlType.Arxiv
            (arxivId := "math.RT/0109107")
        , UrlType.MR
            (mrNumber := "MR1987019")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch03:MR1987019.bib")
        ]
    , title    := "Faithful representations of SL(2) over truncated Witt vectors"
    }
...
def adjoint_jordan_blocks : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "2003-08---adjoint-jordan-blocks.pdf")
        , UrlType.Arxiv
            (arxivId := "math/0207001")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch03:arXiv.0207001.bib")
        ]
...
def component_group_unipotent_centralizer : IO MS := do
  ...
  pure
    { authors  := [GeorgeMcNinch, EricSommers]
    , citation := Citation.Journal
        (journal := "Journal of Algebra")
        (volume  := some 260)
        (year    := 2003)
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1016/S0021-8693(02)00661-0")
        , UrlType.Arxiv
            (arxivId := "math.RT/0204275")
        , UrlType.MR
            (mrNumber := "MR1976698")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch03:MR1976698.bib")
        ]
...
def second_cohomology : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "the-second-cohomology-of-small-modules.pdf")
        , UrlType.DOI
            (doiNumber := "10.2140/pjm.2002.204.459")
        , UrlType.Arxiv
            (arxivId := "math.RT/0006105")
        , UrlType.MR
            (mrNumber := "MR1907901")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch02:MR1907901.bib")
        , UrlType.Errata
            (path := errataPath "Errata---Second-cohomology.pdf")
        ]
    , title    :=
...
def abelian_unipotent_subgroups : IO MS := do
  ...
  pure
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "abelian-unipotent-subgroups-of-reductive-groups.pdf")
        , UrlType.DOI
            (doiNumber := "10.1016/S0022-4049(01)00038-X")
        , UrlType.Arxiv
            (arxivId := "math.RT/0007056")
        , UrlType.MR
            (mrNumber := "MR1874545")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch02:MR1874545.bib")
        , UrlType.Errata
            (path := errataPath
...
def howe_duality : IO MS :=
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1007/s002090000157")
        , UrlType.MR
            (mrNumber := "MR1801579")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch00:MR1801579.bib")
        ]
    , title    := "Filtrations and positive characteristic Howe duality"
    }

def semisimplicity_exterior_powers : IO MS :=
  pure
    { authors  := [GeorgeMcNinch]
    , citation := Citation.Journal
        (journal := "Journal of Algebra")
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1006/jabr.1999.8132")
        , UrlType.MR
            (mrNumber := "MR1741556")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch00:MR1741556.bib")
        , UrlType.Errata
            (path := errataPath "errata---exterior-powers.pdf")
        ]
    , title    :=
        "Semisimplicity of exterior powers of semisimple representations of groups"
    }

def semisimple_finite_Lie : IO MS :=
  pure
    { authors  := [GeorgeMcNinch]
    , citation := Citation.Journal
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "semisimple-modules-for-finite-groups-of-lie-type.pdf")
        , UrlType.DOI
            (doiNumber := "10.1112/S0024610799007966")
        , UrlType.MR
            (mrNumber := "MR1753813")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch99:MR1753813.bib")
        ]
...
def dimensional_criteria : IO MS := do
  ...
  pure
    ...
    , urls     :=
        ...
        , UrlType.DOI
            (doiNumber := "10.1112/S0024611598000045")
        , UrlType.MR
            (mrNumber := "MR1476899")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch98:MR1476899.bib")
        , UrlType.Errata
            (path := errataPath "errata-for-dimensional-criteria.pdf")
        ]
    , title    := "Dimensional criteria for semisimplicity of representations"
    }

def semisimple_pos_char : IO MS :=
  pure
    { authors  := [GeorgeMcNinch]
    , citation := Citation.Proceedings
    ...
    , urls     :=
        [ UrlType.Local
            (path := msPDFPath "semisimplicity-in-positive-characteristic-(survey).pdf")
        , UrlType.MR
            (mrNumber := "MR1670763")
        , UrlType.Bibtex
            (path := bibtexPath "mcninch98:MR1670763.bib")
        ]
    , title    := "Semisimplicity in positive characteristic"
    }

def dimensional_criteria_thesis : IO MS :=
  pure
    { authors  := [GeorgeMcNinch]
    , citation := Citation.PhDThesis
        (year        := 1996)
